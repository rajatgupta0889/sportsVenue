 ...
 *
 * @description :: Server-side logic for managing Appcontrollers
...
module.exports = {
	...
	create:function(req,res){
		...
		key: 'AKIAI3EDOJTTCTQZCEEA',
		secret:'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',
		bucket:'sportimage'
		...
		if(req.body.fee_ground==null)
		{
			...
			App.create(img,function(err,user){
	...
	destroy:function(req,res,next){
		...
		App.findOne(req.param('id'),function findUser(err,form){
			if(err) next(err);

		App.destroy(req.param('id'),function userDestroy(err,form){
